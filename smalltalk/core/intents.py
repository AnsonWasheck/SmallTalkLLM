...
INTENTS: list[Intent] = [
    _i("greeting", "vshort", ["hey"],
       ["hi", "hello", "hey", "yo", "hey there", "hiya", "heya", "hello there",
        ...
        "yo!", "ey up", "alright", "hey stranger", "wotcher", "g'day", "salutations",
        "hey up", "morning!", "evening!", "top of the morning", "hola", "aloha",
        "hi friend", "well hello", "hey hi", "good day", "greetings friend"],
    ...
    _i("good_news", "short", ["that's great!"],
       ["i got the job", "i passed my exam", "we won", "i got promoted",
        ...
        "i heard back and it's good", "the news was good", "it worked out",
        "they said yes", "i got what i wanted", "it went really well",
        "i finally got it", "everything went fine"],
    ...
    _i("bad_news", "short", ["oh no, i'm sorry"],
       ["i lost my job", "my dog died", "we broke up", "i failed the exam",
        ...
        "i heard back and it's bad", "the news was bad", "it didn't work out",
        "they said no", "i didn't get what i wanted", "it went really badly",
        "i never got it", "everything went wrong"],
    ...
    _i("agreement", "reaction", ["yeah exactly"],
       ["i agree", "exactly", "yeah true", "you're right", "same", "definitely",
        ...
        "yeah i reckon", "makes sense", "yeah that's it", "precisely",
        "that's what i said", "no you're right", "yeah fair", "true",
    ...
    _i("user_vents", "short", ["that sounds rough"],
       ["work has been a nightmare", "everyone's been on my case",
        ...
        "i'm so sick of this place", "they keep piling work on me",
        "i've been dealing with this all week", "no one listens to me",
        "i'm honestly at breaking point", "it just keeps getting worse",
        "i can't catch a break", "everything is falling apart"],
