...
def main() -> int:
    ...
    print(f"  elaboration_rate       {res['elaboration_rate']:6.1%}  (known: says something subject-specific)")
    print(f"  false_elaboration_rate {res['false_elaboration_rate']:6.1%}  (unknown: invents specificity)")
    print(f"  fallback_rate          {res['fallback_rate']:6.1%}  (unknown: safe generic/hedge)")
